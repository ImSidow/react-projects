...
import _UserIcon from "./UserIcon";
import _DownloadIcon from "./DownloadIcon";
import _GraphIcon from "./GraphIcon";
import _CalenderIcon from "./CalenderIcon";
...
export const GraphIcon = _GraphIcon
export const CalenderIcon = _CalenderIcon
