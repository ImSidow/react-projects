    ...
    return (
        <div className="flex flex-col justify-center items-center h-full">
            <div className="bg-white w-2/6 rounded-xl p-3 drop-shadow-md">
                <h1 className="text-center text-2xl font-semibold mt-5"> Welcome AOT </h1>
                <p className="text-center text-sm font-light mt-3"> Hello! sign up to get started. </p>

                <form action="" className="px-3 mt-10 mb-5">
                    ...
                    <button type="button" className="text-white w-full mt-5 bg-[#2680FE] hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-[#2680FE] focus:outline-none dark:focus:ring-blue-800">
                        Sign Up
                    </button>
                </form>
            </div>
            ...
            <p className="mt-10 text-sm font-light">
                ...
                <Link to="/sign-in" className="text-[#2680FE] font-semibold ml-1">
                    Sign In
                </Link>
            </p>
        </div>
