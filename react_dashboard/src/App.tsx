    ...
    return (
        <main className="h-screen overflow-hidden flex">
            ...
            <div aria-describedby="main-content" className="w-full h-full">
                ...
                <div className="px-4 py-8 bg-[#F6F6F6] h-full">
                    <nav className="flex justify-between mb-6" aria-label="Breadcrumb">
                        ...
                        <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-1.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                            New Record
                        </button>
                    </nav>
